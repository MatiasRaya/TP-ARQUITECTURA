...
HD_PWD='C:/Users/matia/TP-ARQUI/ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log black_box.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source black_box.tcl -notrace
